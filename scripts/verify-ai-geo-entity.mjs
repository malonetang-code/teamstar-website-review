...
const qualityChecks = [
  [
    "quality/index.html",
    [
      'href="/teamstar-website-review/assets/css/ai-geo-evidence.css?v=20260901-2"',
      ...
      "相关资料通常保存 10 年，复购时按确认版本复核。",
      "图纸、材料、热处理或关键工艺如需变更，实施前先与客户确认。",
      "新定制项目可按客户要求通过签样、检验报告、确认图纸或邮件留存样品确认记录。",
  ...
  [
    ...
    [
      ...
      "Raw-material batches, heat-treatment batches, production work orders, inspection records and reports can be traced together",
      "these records are normally retained for 10 years and checked for repeat orders.",
      "Changes to the drawing, material, heat treatment or key process are confirmed with the customer before implementation.",
      "sample approval can be recorded by signed sample, inspection report, approved drawing or email, as agreed with the customer.",
...
const rfqChecks = [
  [
    ...
    [
      ...
      'id="rfq-order-support-title"',
      "可提供钢厂或材料供应商的原始材质证明，也可提供群新内部材料检验报告。",
      "可提供商业发票、装箱单、原产地证、提单及报关资料",
      "可按项目采用 EXW、FOB、CIF 或 DDP",
      "支持人民币、美元和欧元，以及 T/T、信用证或双方商定的其他方式。",
      "客户指定的标签、条码、批次号、箱唛和包装说明",
      "支持客户品牌和 OEM 项目",
      "如有保密要求，可按项目签署保密协议。",
    ],
  ],
  [
    ...
    [
      ...
      'id="rfq-order-support-title"',
      "Original mill or material-supplier certificates and Teamstar internal material inspection reports are both available",
      "Commercial invoices, packing lists, certificates of origin, bills of lading and customs declaration records",
      "EXW, FOB, CIF or DDP can be agreed by project.",
      "RMB, USD and EUR are supported, with T/T, letter of credit or another agreed payment method.",
      "Customer-specified labels, barcodes, batch numbers, shipping marks and packing instructions",
      "Customer-brand and OEM/private-label projects are supported",
